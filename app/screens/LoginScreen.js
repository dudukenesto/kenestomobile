        ...
        .then( (responseData) => {
            ...
            if (responseData.AuthenticateJsonResult.ResponseStatus == "FAILED")
                 Actions.error({data: 'authentication failed'}); 
                    ...
                    var Token = encodeURIComponent(responseData.AuthenticateJsonResult.Token);
                    ...
                    .then( (responseData) => {
                        ...
                        Actions.tabbar({ sessionToken: encodeURIComponent(responseData.LoginJsonResult.Token)});
